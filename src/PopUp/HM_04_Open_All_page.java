...
//•	After opeing all the page in demo workshop send some value and and click search button
//•	When you are in Goggle page click subscripe button
//•	When you are in Youtube you need to seach any blog in search filed 
//•	In twitter click create new account 
//•	In facebook click create new account.


public class HM_04_Open_All_page extends BaseClass{
